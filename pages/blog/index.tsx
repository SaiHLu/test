...
const BlogIndex: NextPageWithLayout = ({ blogs, categories }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
            ...
            <div className={styles.blog_list}>
              {blogs.map((blog: IBlog) => (
                <div className={styles.blog} key={blog._id}>
                  <BlogCard id={blog._id} title={blog.title} description={blog.description!} imageUrl={blog.image} />
                </div>
              ))}
            </div>

            <BrandButton backgroundColor="#00008b">
              Learn More
            </BrandButton>
          </section>
